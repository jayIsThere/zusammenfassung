...
1. **Skalarprodukt (Dot Product)**  
   ...
   <img src="{{ site.baseurl }}/skalarprodukt.jpg" width="450px" height="350px">
...
2. **Vektorlänge (Norm)**  
   ...
   <img src="{{ site.baseurl }}/vektorlaenge.jpg" width="450px" height="350px">
...
3. **Winkel zwischen Vektoren (Angle between Vectors)**  
   ...
   <img src="{{ site.baseurl }}/winkel.jpg" width="450px" height="350px">
...
4. **Orthogonalität (Orthogonality)**  
   ...
   <img src="{{ site.baseurl }}/orthogonal.jpg" width="450px" height="350px">
...
5. **Kreuzprodukt (Cross Product) - In 3D**  
   ...
   <img src="{{ site.baseurl }}/kreuzprodukt.jpg" width="450px" height="350px">
...
1. **Matrixmultiplikation (Matrix Multiplication)**  
   ...
   <img src="{{ site.baseurl }}/matrix_multiplikation.jpg" width="450px" height="350px">
...
#### Übungsblatt 1
   ...
   <img src="{{ site.baseurl }}/uebungsblatt1-1.jpg" width="450px" height="350px">
   <img src="{{ site.baseurl }}/uebungsblatt1-2.jpg" width="450px" height="350px">
   <img src="{{ site.baseurl }}/uebungsblatt1-3.jpg" width="450px" height="350px">
